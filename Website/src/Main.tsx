...
import TotalKIcon from './img/bow-svgrepo-com.svg';
...
const Main: React.FC<Props> = (props: Props) => {
    ...
    const fetchPlayerData = async () => {
        try {
            ...
            const docRef = db.collection('JUN_2024_KVK').doc(props.userID);
                    ...
                    <>
                        ...
                        <div className='AlttimeGroup'>
                            <div className="Alltime-stats-container">
                                ...
                                <div className="All-stats">
                                    <h2 className="main-stats-title"> Pass 7 Fights</h2>
                                    <br></br>
                                    <div className="main-stat-wrapper">
                                        <span className="main-stat-label">Deaths:</span>
                                        <p className="main-stat">{playerData?.Pass4_Deaths?.toLocaleString()}</p>
                                ...
                                <div className="All-stats">
                                    <h2 className="main-stats-title"> Pass 8 Fights</h2>
                                    <br></br>
                                    <div className="main-stat-wrapper">
                                        <span className="main-stat-label">Deaths:</span>
                                        <p className="main-stat">{playerData?.Pass4_Deaths?.toLocaleString()}</p>
            ...
            <main className="main-main">
                <section style={{ gridArea: 'yourStats' }}>
                    <div className='section-container' style={{ display: 'flex', alignItems: 'center' }}>
                        ...
                        <a onClick={handleSignOut} title="Sign out" style={{ cursor: 'pointer', display: 'flex', alignItems: 'center', fill: 'white' }}>
